...
CREATE TABLE `activities` (
  ...
  `execution_weekday` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `execution_hour` time NOT NULL,
  `results` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `collaborators` (
  ...
  `academic_function` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `profissional_registry` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_format` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `extension_lines` (
  ...
  `operation_way` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `finished_projects` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint(20) unsigned NOT NULL,
  `project_evaluation` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `future_development_plans` (
  ...
  `participants_number_forecast` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `new_demands` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint(20) unsigned NOT NULL,
  `demand` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `performed_publications` (
  ...
  `type` enum('artigo','capitulo','resumo') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `project_attachments` (
  ...
  `project_id` bigint(20) unsigned NOT NULL,
  `attachment_id` bigint(20) unsigned NOT NULL,
  `attachment_type` enum('document','image','video','publication','event','assigns_list','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `project_publics` (
  ...
  `other_public_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_public_cras` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `project_targets` (
  ...
  `age_range` enum('Até 12 anos incompletos','Até 18 anos','De 19 a 25 anos','De 26 a 30 anos','De 31 a 50 anos','De 51 a 60 anos','De 61a 70 anos','Acima de 70 anos') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `projects` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `institutional_link_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_season` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `involved_classes` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `pcc_calendar_classes_articulation` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `preview_credits_classes` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `infrastructure` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `public_participation` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `accompaniment_and_evaluation` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `publics` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cras` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
