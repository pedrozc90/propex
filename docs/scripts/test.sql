...
INSERT INTO projects (title, program, start_season, included_courses, ppc_and_course_calendar, required_courses_credits, infrastructure, public_participation, accompaniment_and_evaluation) VALUES
    ("Projeto Teste 1", "Atividade Avaliativa", "2019/01", "Ciências da Computação", "???", "Engenharia de Software I, Engenharia de Software II", "???", "Nenhuma", "Excelente"),
    ("Projeto Teste 2", "Atividade Avaliativa", "2019/02", "Ciências da Computação", "???", "Engenharia de Software I, Engenharia de Software II", "???", "Nenhuma", "Bom"),
...
INSERT INTO users (name, email, password, phone) VALUES
    ...
    ("user8", "user8@domain.com", "123456", "(48) 00000-0008"),
    ("user9", "user9@domain.com", "123456", "(48) 00000-0009"),
    ("user10", "user10@domain.com", "123456", "(48) 00000-0010"),
    ("user11", "user11@domain.com", "123456", "(48) 00000-0011"),
    ("user12", "user12@domain.com", "123456", "(48) 00000-0012");
...
INSERT INTO students (code, course, period, scholarship, user_id) VALUES 
    ("x000005", "Ciências da Computação", 6, false, 6),
    ("x000006", "Ciências da Computação", 7, true , 7),
    ("x000007", "Ciências da Computação", 8, true , 8),
    ("x000008", "Ciências da Computação", 7, true , 9),
    ("x000009", "Ciências da Computação", 8, false, 10),
    ("x000010", "Ciências da Computação", 9, false, 11),
    ("x000011", "Ciências da Computação", 9, false, 12),
    ("x000012", "Ciências da Computação", 5, true , 13);
...
INSERT INTO project_human_resources (project_id, user_id, coordinate, exclusive, workload, dt_admission) VALUES
    ...
    (1, 3, 0, 1, 36, "2020-01-01"),
    (2, 4, 1, 1, 48, "2020-01-01"),
    (3, 5, 1, 1, 48, "2020-01-01"),
    
    (1, 6, 0, 0, 12, "2020-01-01"),
    (1, 7, 0, 0, 12, "2020-01-01"),
    (1, 8, 0, 0, 12, "2020-01-01"),
    (1, 9, 0, 0, 12, "2020-01-01"),
    (1, 13, 0, 0, 12, "2020-01-01"),

    (2, 10, 0, 0, 12, "2020-01-01"),
    (2, 11, 0, 0, 12, "2020-01-01"),
    (2, 12, 0, 0, 12, "2020-01-01"),

    (3, 12, 0, 0, 12, "2020-01-01"),
    (3, 13, 0, 0, 12, "2020-01-01");
